...
const Team = () => {
  ...
  return (
    <>
      <div>
      <h2 className='titleStyle'>Our <span>Team </span></h2>

      <div className='containerStyle'>
        <div className='cardStyle'>
          <img src={team_1} alt="Cathy" style={{ width: "100%", borderRadius: "8px" }} />
          <h3 style={{ margin: "10px 0" }}>Cathy Aenderson</h3>
          <p style={{ color: "gray" }}>Chief Executive</p>
        </div>

        <div className='cardStyle'>
          <img src={team_2} alt="Mike" style={{ width: "100%", borderRadius: "8px" }} />
          <h3 style={{ margin: "10px 0" }}>Mike Dooley</h3>
          <p style={{ color: "gray" }}>Executive</p>
        </div>

        <div className='cardStyle'>
          <img src={team_3} alt="Alextina" style={{ width: "100%", borderRadius: "8px" }} />
    ...
    <div>
<div className="slider-container" style={{width:'100%' ,margin:'auto',marginTop:'100px',marginBottom:'50px'}}>
      <Slider {...settings}>
        <div>
